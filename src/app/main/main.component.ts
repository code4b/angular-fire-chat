  ...
  getAllUsers() {
    ...
    this.api.getUsers().pipe(
      ...
      console.log('data', data)
        ...
        //  let find = this.api.currentUser.conversations ? this.api.currentUser.conversations.find(el => el.uid == item.uid):undefined
          if(item.email!=this.api.currentUser.email){
